...
@Api(value = "SettingsController", description = "Rest Api used for user settings")
@RestController
...
public class SettingsController {
    ...
    @GetMapping("/getSetting/{setting}")
    public String getSetting(@RequestParam String setting) {
        return setting;
    }
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 403, message = "forbidden!!!"),
            @ApiResponse(code = 404, message = "not found!!!") })
    @PutMapping("/changeSetting")
    public void changeSetting(@RequestParam String setting, @RequestParam String value) {
