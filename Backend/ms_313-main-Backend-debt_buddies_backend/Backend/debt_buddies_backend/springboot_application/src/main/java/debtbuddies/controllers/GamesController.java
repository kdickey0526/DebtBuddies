...
@Api(value = "GamesController", description = "Rest Api used for game highscores")
@RestController
...
public class GamesController {
    ...
    @GetMapping("/getScores/{game}")
    public String getSetting(@RequestParam String game) {
        return "Scores for " + game;
    }
    ...
    public String getSetting(@RequestParam String game, @RequestParam int value) {
        return Integer.toString(value) + " added to " + game + " leaderboard";
    }
